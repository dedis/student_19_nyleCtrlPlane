...
%%%%%%%%%%%%%%%%%%%%
This work builds upon several other work that are linked to the domains of
...
system. It is somehow orthogonal to them because it can use any cryptocurrency
system as an underlying system and enhance them using the idea of locality to
add some partition-resistance to them. The Sybil-resistance scheme used in the
registration system is directly inspired from \cite{Dfinity}, using
...
cryptocurrencies like \cite{bitcoin-paper}, solving the problem of waiting time
for validation using region validation and making it resistant to WW3
scenarios. \cite{Byzcoin}, \cite{Omniledger} gives an interesting solution to
the waiting time for validation, but they are orthogonal to this research.
