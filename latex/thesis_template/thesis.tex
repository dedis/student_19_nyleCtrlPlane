...
\caption{ A node participates in two kind of regions. The ones it creates with a radius from $R_min$ to one that is covering its cluster (orange). And some regions created by the nodes in its cluster, which are covergin him  (blue) .  }
