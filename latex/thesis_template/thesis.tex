...
should remain fixed. The Locarno Treaties defined some of these borders \cite{LocarnoTreaties TODO}. The
idea of this Strawman model is to limit modifications of regions from one epoch to the next. The
...
from one epoch to another, the purpose of the game is to keep as much regions as
possible. The obvious idea to reach this goal is to let the nodes conserves their levels from one epoch to the next. 
However some small difference should be introduced in order to avoid some problems.
...
Instead of drawing directly the levels from a randomness source, nodes will draw a
