...
to speed the system up. However, it is not directly related to blockchains. The next \Cref{chap:RelatedWork} describes the rest
of the related work. 
...
These are described in detail in \Cref{chap:Background}. There is a class of
...
Some answers to these drawbacks are proposed in \Cref{chap:Improvements}.  
